...
public class TbKcGoods {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(goodsId, goodsPy, goodsCode, goodsName, storeWarning, salePrice, memberPrice, discountsPrice, discountsStartTime, discountsEndTime, status, createTime, createUserName, lastUpdateTime, goodsUnit, unitCount, isDiscounts);
    }
}
